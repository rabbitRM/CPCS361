...
public class SRR {
    ...
    // Fixed quantum = 10 + Team number 
    public static int quantum = 10 + 6 ;
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        output = new PrintWriter("output24.txt");
    ...
    // ----------------------------------------------------------------------------------
    // Mehtod to terminate the process in the CPU -> not needed anymore
